...
void StatementFor() // 원하는 횟수 만큼 반복
{
  // integer, iterate(interable) : 반복하다
for (int i = 0; i < 10; i++)
  {
    cout << i;
  }
...
void StatementWhile() // 올바른 값을 입력할 때까지 무한 반복
{
...
void VarScope(int Number) // 변수 값 적용 범위 
{
